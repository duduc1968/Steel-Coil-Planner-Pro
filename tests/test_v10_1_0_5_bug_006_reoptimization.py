...
def test_version_is_10_1_0_5():
    assert any(v in HTML.read_text(encoding="utf-8") for v in ("v10.1.0.5", "v10.2.0.0", "v10.2.0.1", "v10.2.0.2", "v10.2.0.3", "v10.2.0.4", "v10.2.0.5", "v10.2.0.6", "v10.2.0.7", "v10.2.0.8"))
